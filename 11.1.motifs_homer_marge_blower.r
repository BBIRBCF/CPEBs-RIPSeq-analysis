...
## our parameters
path <- file.path(.reportsdir,'homer_output_blower')
system(paste("mkdir -p", path))
...
path <- file.path(.reportsdir,'motifs_homer_blower_cpeb1234_vs_bg_120620')
...
background <- '/Volumes/biostats/consulting/raul_mendez/bduran_201903_ripseq/data/blower_pas_seq/most_reads_fasta.fa'
path <- file.path(.reportsdir,'motifs_homer_blower_cpeb1_vs_bg_120620')
out <- run_homer_fasta(homer_base, fasta, path, background, run=TRUE)
...
background <- '/Volumes/biostats/consulting/raul_mendez/bduran_201903_ripseq/data/blower_pas_seq/most_reads_fasta.fa'
path <- file.path(.reportsdir,'motifs_homer_blower_cpeb234_vs_bg_120620')
out <- run_homer_fasta(homer_base, fasta, path, background, run=TRUE)
...
path <- file.path(.reportsdir,'motifs_homer_blower_cpeb1_vs_cpeb234_120620')
out <- run_homer_fasta(homer_base, fasta, path, background, run=TRUE)
...
path <- file.path(.reportsdir,'motifs_homer_blower_cpeb234_vs_cpeb1_120620')
out <- run_homer_fasta(homer_base, fasta, path, background, run=TRUE)
...
path <- file.path(.reportsdir,'motifs_homer_blower_cpeb1_vs_cpeb1234_120620')
out <- run_homer_fasta(homer_base, fasta, path, background, run=TRUE)

## Launch Homer, CPEB1234 vs CPEB1
fasta <- '/Volumes/biostats/consulting/raul_mendez/bduran_201903_ripseq/data/blower_pas_seq/most_reads_fasta_cpeb1234.fa'
background <- '/Volumes/biostats/consulting/raul_mendez/bduran_201903_ripseq/data/blower_pas_seq/most_reads_fasta_cpeb1.fa'
path <- file.path(.reportsdir,'motifs_homer_blower_cpeb1234_vs_cpeb1_120620')
out <- run_homer_fasta(homer_base, fasta, path, background, run=TRUE)
